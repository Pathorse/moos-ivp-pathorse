...
CFrontEstimate2::CFrontEstimate2()
{
  num_param = 9;
  num_meas = 0;
  in_survey = false;
...
bool CFrontEstimate2::OnStartUp()
{
...
bool CFrontEstimate2::OnConnectToServer()
{
...
bool CFrontEstimate2::OnNewMail(MOOSMSG_LIST &NewMail)
...
void CFrontEstimate2::postParameterReport()
{
  string sval;
  sval = "vname=" + vname;
...
bool CFrontEstimate2::buildReport()
{
  
  m_msgs<<"CFrontEstimate2 report"<<endl;
...
void CFrontEstimate2::updateWaypoints()
{
  // find values
  double x0    = 0;
  double y0    = offset;
