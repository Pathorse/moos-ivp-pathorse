...
BHV_AlternatePoints::BHV_AlternatePoints(IvPDomain gdomain) :
  IvPBehavior(gdomain)
{
...
void BHV_AlternatePoints::onSetParamComplete()
{
...
bool BHV_AlternatePoints::setParam(string param, string param_val)
{
...
void BHV_AlternatePoints::onIdleToRunState()
{
  if(!updateInfoIn()) 
    return;
  m_odo_leg_disq = true;
...
void BHV_AlternatePoints::onRunToIdleState()
{
  postErasables();
...
BehaviorReport BHV_AlternatePoints::onRunState(string input)
{
...
IvPFunction *BHV_AlternatePoints::onRunState()
{
...
void BHV_AlternatePoints::onIdleState()
{
  if(!updateInfoIn()) 
    return;
}
...
bool BHV_AlternatePoints::updateInfoIn()
{
...
bool BHV_AlternatePoints::setNextWaypoint()
{
...
IvPFunction *BHV_AlternatePoints::buildOF(string method)
{
  IvPFunction *ipf = 0;
...
void BHV_AlternatePoints::postStatusReport()
{
  int    current_waypt = m_waypoint_engine.getCurrIndex();
...
void BHV_AlternatePoints::postViewableSegList()
{
...
void BHV_AlternatePoints::postErasables()
{
  postMessage("VIEW_POINT", m_trackpt.get_spec("active=false"), "trk");
  postMessage("VIEW_POINT", m_nextpt.get_spec("active=false"), "wpt");
...
void BHV_AlternatePoints::postCycleFlags()
{
...
void BHV_AlternatePoints::postWptFlags(double x, double y)
{
...
void BHV_AlternatePoints::handleVisualHint(string hint)
{
...
void BHV_AlternatePoints::checkLeadConditions()
{
  if(!m_info_buffer) 
    return;
...
void BHV_AlternatePoints::updateOdoDistance()
{
  if(!m_odo_virgin) {
...
void BHV_AlternatePoints::markOdoLeg()
{
